...
func (a *DefaultAPIService) AdminRealmsRealmClientsClientUuidAuthzResourceServerResourceGetExecute(r ApiAdminRealmsRealmClientsClientUuidAuthzResourceServerResourceGetRequest) ([]ResourceRepresentation, *http.Response, error) {
	...
	if r.exactName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exactName", r.exactName, "form", "")
	}
	if r.first != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "first", r.first, "form", "")
	}
	if r.matchingUri != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "matchingUri", r.matchingUri, "form", "")
	}
	if r.max != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "max", r.max, "form", "")
	}
