...
// GetMaxTemporaryLockouts returns the MaxTemporaryLockouts field value if set, zero value otherwise.
func (o *RealmRepresentation) GetMaxTemporaryLockouts() int32 {
	if o == nil || IsNil(o.MaxTemporaryLockouts) {
		var ret int32
		return ret
	}
	return *o.MaxTemporaryLockouts
}

// GetMaxTemporaryLockoutsOk returns a tuple with the MaxTemporaryLockouts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetMaxTemporaryLockoutsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxTemporaryLockouts) {
		return nil, false
	}
	return o.MaxTemporaryLockouts, true
}
...
// SetMaxTemporaryLockouts gets a reference to the given int32 and assigns it to the MaxTemporaryLockouts field.
func (o *RealmRepresentation) SetMaxTemporaryLockouts(v int32) {
	o.MaxTemporaryLockouts = &v
}

// GetBruteForceStrategy returns the BruteForceStrategy field value if set, zero value otherwise.
func (o *RealmRepresentation) GetBruteForceStrategy() BruteForceStrategy {
	if o == nil || IsNil(o.BruteForceStrategy) {
		var ret BruteForceStrategy
		return ret
	}
	return *o.BruteForceStrategy
}

// GetBruteForceStrategyOk returns a tuple with the BruteForceStrategy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetBruteForceStrategyOk() (*BruteForceStrategy, bool) {
	if o == nil || IsNil(o.BruteForceStrategy) {
		return nil, false
	}
	return o.BruteForceStrategy, true
}
...
// SetBruteForceStrategy gets a reference to the given BruteForceStrategy and assigns it to the BruteForceStrategy field.
func (o *RealmRepresentation) SetBruteForceStrategy(v BruteForceStrategy) {
	o.BruteForceStrategy = &v
}
...
// GetAdminPermissionsClient returns the AdminPermissionsClient field value if set, zero value otherwise.
func (o *RealmRepresentation) GetAdminPermissionsClient() ClientRepresentation {
	if o == nil || IsNil(o.AdminPermissionsClient) {
		var ret ClientRepresentation
		return ret
	}
	return *o.AdminPermissionsClient
}

// GetAdminPermissionsClientOk returns a tuple with the AdminPermissionsClient field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetAdminPermissionsClientOk() (*ClientRepresentation, bool) {
	if o == nil || IsNil(o.AdminPermissionsClient) {
		return nil, false
	}
	return o.AdminPermissionsClient, true
}
...
// SetAdminPermissionsClient gets a reference to the given ClientRepresentation and assigns it to the AdminPermissionsClient field.
func (o *RealmRepresentation) SetAdminPermissionsClient(v ClientRepresentation) {
	o.AdminPermissionsClient = &v
}
...
// SetLocalizationTexts gets a reference to the given map[string]map[string]string and assigns it to the LocalizationTexts field.
...
// SetClientScopeMappings gets a reference to the given map[string][]ScopeMappingRepresentation and assigns it to the ClientScopeMappings field.
...
func (o *RealmRepresentation) GetComponents() map[string][]ComponentExportRepresentation {
	if o == nil || IsNil(o.Components) {
		var ret map[string][]ComponentExportRepresentation
		return ret
	}
	return *o.Components
}
...
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetComponentsOk() (*map[string][]ComponentExportRepresentation, bool) {
	if o == nil || IsNil(o.Components) {
		return nil, false
	}
...
// SetComponents gets a reference to the given map[string][]ComponentExportRepresentation and assigns it to the Components field.
func (o *RealmRepresentation) SetComponents(v map[string][]ComponentExportRepresentation) {
	o.Components = &v
}
...
// GetFirstBrokerLoginFlow returns the FirstBrokerLoginFlow field value if set, zero value otherwise.
func (o *RealmRepresentation) GetFirstBrokerLoginFlow() string {
	if o == nil || IsNil(o.FirstBrokerLoginFlow) {
		var ret string
		return ret
	}
	return *o.FirstBrokerLoginFlow
}

// GetFirstBrokerLoginFlowOk returns a tuple with the FirstBrokerLoginFlow field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetFirstBrokerLoginFlowOk() (*string, bool) {
	if o == nil || IsNil(o.FirstBrokerLoginFlow) {
		return nil, false
	}
	return o.FirstBrokerLoginFlow, true
}

// HasFirstBrokerLoginFlow returns a boolean if a field has been set.
func (o *RealmRepresentation) HasFirstBrokerLoginFlow() bool {
	if o != nil && !IsNil(o.FirstBrokerLoginFlow) {
		return true
	}
...
// SetFirstBrokerLoginFlow gets a reference to the given string and assigns it to the FirstBrokerLoginFlow field.
func (o *RealmRepresentation) SetFirstBrokerLoginFlow(v string) {
	o.FirstBrokerLoginFlow = &v
}
...
// GetOrganizationsEnabled returns the OrganizationsEnabled field value if set, zero value otherwise.
func (o *RealmRepresentation) GetOrganizationsEnabled() bool {
	if o == nil || IsNil(o.OrganizationsEnabled) {
		var ret bool
		return ret
	}
	return *o.OrganizationsEnabled
}

// GetOrganizationsEnabledOk returns a tuple with the OrganizationsEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetOrganizationsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.OrganizationsEnabled) {
		return nil, false
	}
	return o.OrganizationsEnabled, true
}

// HasOrganizationsEnabled returns a boolean if a field has been set.
func (o *RealmRepresentation) HasOrganizationsEnabled() bool {
	if o != nil && !IsNil(o.OrganizationsEnabled) {
		return true
	}
...
// SetOrganizationsEnabled gets a reference to the given bool and assigns it to the OrganizationsEnabled field.
func (o *RealmRepresentation) SetOrganizationsEnabled(v bool) {
	o.OrganizationsEnabled = &v
}

// GetOrganizations returns the Organizations field value if set, zero value otherwise.
func (o *RealmRepresentation) GetOrganizations() []OrganizationRepresentation {
	if o == nil || IsNil(o.Organizations) {
		var ret []OrganizationRepresentation
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetOrganizationsOk() ([]OrganizationRepresentation, bool) {
	if o == nil || IsNil(o.Organizations) {
		return nil, false
	}
...
func (o *RealmRepresentation) HasOrganizations() bool {
	if o != nil && !IsNil(o.Organizations) {
		return true
	}
...
// SetOrganizations gets a reference to the given []OrganizationRepresentation and assigns it to the Organizations field.
...
// GetAdminPermissionsEnabled returns the AdminPermissionsEnabled field value if set, zero value otherwise.
func (o *RealmRepresentation) GetAdminPermissionsEnabled() bool {
	if o == nil || IsNil(o.AdminPermissionsEnabled) {
		var ret bool
		return ret
	}
	return *o.AdminPermissionsEnabled
}

// GetAdminPermissionsEnabledOk returns a tuple with the AdminPermissionsEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetAdminPermissionsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.AdminPermissionsEnabled) {
		return nil, false
	}
	return o.AdminPermissionsEnabled, true
}
...
// SetAdminPermissionsEnabled gets a reference to the given bool and assigns it to the AdminPermissionsEnabled field.
func (o *RealmRepresentation) SetAdminPermissionsEnabled(v bool) {
	o.AdminPermissionsEnabled = &v
}
...
func (o RealmRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxTemporaryLockouts) {
		toSerialize["maxTemporaryLockouts"] = o.MaxTemporaryLockouts
	}
	if !IsNil(o.BruteForceStrategy) {
		toSerialize["bruteForceStrategy"] = o.BruteForceStrategy
	}
	...
	if !IsNil(o.AdminPermissionsClient) {
		toSerialize["adminPermissionsClient"] = o.AdminPermissionsClient
	}
	...
	if !IsNil(o.FirstBrokerLoginFlow) {
	...
	if !IsNil(o.OrganizationsEnabled) {
		toSerialize["organizationsEnabled"] = o.OrganizationsEnabled
	}
	...
	if !IsNil(o.AdminPermissionsEnabled) {
		toSerialize["adminPermissionsEnabled"] = o.AdminPermissionsEnabled
	}
	if !IsNil(o.Social) {
