...
func (a *RealmsAdminAPIService) AdminRealmsRealmAdminEventsGetExecute(r ApiAdminRealmsRealmAdminEventsGetRequest) ([]AdminEventRepresentation, *http.Response, error) {
	...
	if r.operationTypes != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "operationTypes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "operationTypes", t, "form", "multi")
		}
	}
...
func (r ApiAdminRealmsRealmClientPoliciesPoliciesGetRequest) IncludeGlobalPolicies(includeGlobalPolicies bool) ApiAdminRealmsRealmClientPoliciesPoliciesGetRequest {
...
func (a *RealmsAdminAPIService) AdminRealmsRealmClientPoliciesPoliciesGetExecute(r ApiAdminRealmsRealmClientPoliciesPoliciesGetRequest) (*ClientPoliciesRepresentation, *http.Response, error) {
	...
	if r.includeGlobalPolicies != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include-global-policies", r.includeGlobalPolicies, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiAdminRealmsRealmClientTypesGetRequest) Execute() (*ClientTypesRepresentation, *http.Response, error) {
	return r.ApiService.AdminRealmsRealmClientTypesGetExecute(r)
}

/*
AdminRealmsRealmClientTypesGet List all client types available in the current realm
...
func (a *RealmsAdminAPIService) AdminRealmsRealmClientTypesGetExecute(r ApiAdminRealmsRealmClientTypesGetRequest) (*ClientTypesRepresentation, *http.Response, error) {
	...
	localVarPath := localBasePath + "/admin/realms/{realm}/client-types"
	localVarPath = strings.Replace(localVarPath, "{"+"realm"+"}", url.PathEscape(parameterValueToString(r.realm, "realm")), -1)
...
func (r ApiAdminRealmsRealmClientTypesPutRequest) ClientTypesRepresentation(clientTypesRepresentation ClientTypesRepresentation) ApiAdminRealmsRealmClientTypesPutRequest {
	r.clientTypesRepresentation = &clientTypesRepresentation
	return r
}

func (r ApiAdminRealmsRealmClientTypesPutRequest) Execute() (*http.Response, error) {
	return r.ApiService.AdminRealmsRealmClientTypesPutExecute(r)
}

/*
AdminRealmsRealmClientTypesPut Update a client type
...
func (a *RealmsAdminAPIService) AdminRealmsRealmClientTypesPutExecute(r ApiAdminRealmsRealmClientTypesPutRequest) (*http.Response, error) {
	...
	// body params
	localVarPostBody = r.clientTypesRepresentation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
