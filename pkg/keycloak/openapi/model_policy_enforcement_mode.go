...
const (
	POLICYENFORCING PolicyEnforcementMode = "ENFORCING"  // EDITED for compilation
	POLICYPERMISSIVE PolicyEnforcementMode = "PERMISSIVE"  // EDITED for compilation
	POLICYDISABLED PolicyEnforcementMode = "DISABLED"  // EDITED for compilation
)
