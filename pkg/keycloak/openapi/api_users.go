...
func (r ApiAdminRealmsRealmUsersUserIdUnmanagedAttributesGetRequest) Execute() (*map[string][]string, *http.Response, error) {
	return r.ApiService.AdminRealmsRealmUsersUserIdUnmanagedAttributesGetExecute(r)
}
...
func (a *UsersAPIService) AdminRealmsRealmUsersUserIdUnmanagedAttributesGetExecute(r ApiAdminRealmsRealmUsersUserIdUnmanagedAttributesGetRequest) (*map[string][]string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/admin/realms/{realm}/users/{user-id}/unmanagedAttributes"
	localVarPath = strings.Replace(localVarPath, "{"+"realm"+"}", url.PathEscape(parameterValueToString(r.realm, "realm")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"user-id"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
