...
// GetHideOnLogin returns the HideOnLogin field value if set, zero value otherwise.
func (o *IdentityProviderRepresentation) GetHideOnLogin() bool {
	if o == nil || IsNil(o.HideOnLogin) {
		var ret bool
		return ret
	}
	return *o.HideOnLogin
}

// GetHideOnLoginOk returns a tuple with the HideOnLogin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityProviderRepresentation) GetHideOnLoginOk() (*bool, bool) {
	if o == nil || IsNil(o.HideOnLogin) {
		return nil, false
	}
	return o.HideOnLogin, true
}
...
// SetHideOnLogin gets a reference to the given bool and assigns it to the HideOnLogin field.
func (o *IdentityProviderRepresentation) SetHideOnLogin(v bool) {
	o.HideOnLogin = &v
}
