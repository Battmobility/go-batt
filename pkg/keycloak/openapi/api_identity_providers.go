...
func (r ApiAdminRealmsRealmIdentityProviderInstancesGetRequest) RealmOnly(realmOnly bool) ApiAdminRealmsRealmIdentityProviderInstancesGetRequest {
	r.realmOnly = &realmOnly
	return r
}
...
func (a *IdentityProvidersAPIService) AdminRealmsRealmIdentityProviderInstancesGetExecute(r ApiAdminRealmsRealmIdentityProviderInstancesGetRequest) ([]IdentityProviderRepresentation, *http.Response, error) {
	...
	if r.realmOnly != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "realmOnly", r.realmOnly, "form", "")
	}
	if r.search != nil {
