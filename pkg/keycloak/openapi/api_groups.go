...
func (r ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest) Exact(exact bool) ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest {
	r.exact = &exact
	return r
}
...
func (r ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest) Search(search string) ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest {
	r.search = &search
	return r
}
